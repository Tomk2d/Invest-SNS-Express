...
const data = fs.readFileSync('/Users/shin-uijin/SNS/app-server-1/data/kosdaq_code.mst');
...
// JSON 객체를 파일로 저장
fs.writeFile('/Users/shin-uijin/SNS/app-server-1/data/kosdaq.json', JSON.stringify(jsonResult, null, 2), 'utf8', (err) => {
  if (err) throw err;
